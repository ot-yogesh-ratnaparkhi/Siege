...
namespace Siege.ServiceLocation.UnityAdapter
{
    public class OpenGenericUseCaseBinding : IOpenGenericUseCaseBinding
    {
        ...
        public OpenGenericUseCaseBinding(IUnityContainer container)
        {
        ...
        public void Bind(IUseCase useCase, IFactoryFetcher locator)
        {
            ...
            //}
            container.RegisterType(useCase.GetBaseBindingType(), useCase.GetBoundType(), new TransientLifetimeManager());
        }
    }
}