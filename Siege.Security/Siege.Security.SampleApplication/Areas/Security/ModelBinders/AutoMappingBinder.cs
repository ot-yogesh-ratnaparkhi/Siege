...
namespace Siege.Security.SampleApplication.Areas.Security.ModelBinders
{
        ...
        where TProvider : IProvider<T, TID>
    {
        ...
        public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if (System.Web.HttpContext.Current.Request.HttpMethod == "POST") result = Mapper.Map(model, result);
