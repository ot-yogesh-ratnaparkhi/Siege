...
using Siege.Proxy.Attributes;
using Siege.Proxy.Interceptors.Methods.ProcessEncapsulating;
using Siege.TypeGenerator;

namespace Siege.Proxy
{
    public class SiegeProxy
{
    	private static readonly Hashtable definedTypes = new Hashtable();
        private bool useServiceLocator;
        private static readonly TypeGenerator.TypeGenerator generator = new TypeGenerator.TypeGenerator();
